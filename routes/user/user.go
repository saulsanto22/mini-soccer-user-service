...
import (
	controller "user-service/controllers"
...
type UserRoute struct {
	controller controller.IControllerRegistry
...
func NewUserRoute(controller controller.IControllerRegistry, group *gin.RouterGroup) IUserRoute {
